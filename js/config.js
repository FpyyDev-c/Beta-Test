...
/**
 * FpyyCord — banco de dados de servidores/perfis via GitHub.
 *
 * ⚠️ IMPORTANTE — leia js/gh-db.js antes de preencher TOKEN.
 * Este arquivo é público (qualquer visitante do site pode abri-lo e ler
 * o token). Use um "Fine-grained personal access token" do GitHub com
 * acesso SOMENTE a este repositório e permissão SOMENTE de
 * "Contents: Read and write". Nunca use um token com mais acesso que isso.
 *
 * Como preencher:
 *  1. OWNER: seu usuário do GitHub (ex: "joaosilva")
 *  2. REPO: o nome deste repositório (ex: "FpyyCord")
 *  3. BRANCH: geralmente "main"
 *  4. TOKEN: crie em https://github.com/settings/personal-access-tokens/new
 */
window.SR_CONFIG.GITHUB_DB = {
  ENABLED: true,
  OWNER: "FpyyDev-c",
  REPO: "FpyyCord",
  BRANCH: "main",
  TOKEN: "COLOQUE_SEU_TOKEN_AQUI",
  PATH_SERVERS: "data/servers.json",
  PATH_PROFILES: "data/profiles.json",
};

// Senha do painel de admin (troque isso!). Como o site é 100% estático,
// isso NÃO é segurança de verdade — só evita que qualquer visitante
// casual abra o painel sem querer. Qualquer pessoa que veja o código-fonte
// consegue ler essa senha.
window.SR_CONFIG.ADMIN_PASSWORD = "fpycord-admin-2026";
